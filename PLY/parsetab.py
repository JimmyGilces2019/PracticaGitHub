...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','PLYCalculadora.py',45),
  ('expr -> expr MINUS expr','expr',3,'p_sub','PLYCalculadora.py',49),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','PLYCalculadora.py',53),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','PLYCalculadora.py',57),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','PLYCalculadora.py',58),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','PLYCalculadora.py',69),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','PLYCalculadora.py',73),
]
